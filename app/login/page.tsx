    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          background: C.forestDark, color: C.cream,
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.marbleBase, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 400, textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: "'Raleway',sans-serif", fontSize: 13, color: C.inkFaint, marginBottom: 40 }}>
          Sign in to continue to Wilourin
        </p>
